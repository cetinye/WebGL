...
public class AudioManager : MonoBehaviour
    ...
    void Awake()
    {
        ...
        public void Play(W59_Enums.eW59FxSoundStates name)
    {
        Sound sound = sounds.Find(sound => sound.name == name);
        sound.source.Play();
    }

        public void PlayOneShot(W59_Enums.eW59FxSoundStates name)
        {
        ...
        public void PlayIf(W59_Enums.eW59FxSoundStates name)
        {
            Sound sound = sounds.Find(sound => sound.name == name);
        ...
        public void PlayAt(W59_Enums.eW59FxSoundStates name, float startTime)
        {
            Sound sound = sounds.Find(sound => sound.name == name);
        ...
        {
            W59_Enums.eW59FxSoundStates name = (W59_Enums.eW59FxSoundStates)comboValue;
            Sound sound = sounds.Find(sound => sound.name == name);
            sound.source.PlayOneShot(sound.clip);
        }
        ...
        public void Stop(W59_Enums.eW59FxSoundStates name)
        {
            Sound sound = sounds.Find(sound => sound.name == name);
            sound.source.Stop();
        }

        public AudioSource GetSoundSource(W59_Enums.eW59FxSoundStates name)
        {
            Sound sound = sounds.Find(sound => sound.name == name);
            return sound.source;
        }

        public void FadeTo(W59_Enums.eW59FxSoundStates name, float target, float time)
        {
            Sound sound = sounds.Find(sound => sound.name == name);
        ...
        IEnumerator DelayedPlay(W59_Enums.eW59FxSoundStates name, float timeToWait)
        {
    ...
    public class Sound
    {
        public W59_Enums.eW59FxSoundStates name;
