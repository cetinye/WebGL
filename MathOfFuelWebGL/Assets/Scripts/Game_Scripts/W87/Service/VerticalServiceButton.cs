...
{
    public class VerticalServiceButton : ServiceButton
    {
        ...
        public override void OnDrag(PointerEventData eventData)
        {
            ...
            var localPosY = transform.parent.InverseTransformPoint(pos).y;

            var valueNew = GetValue(localPosY);
