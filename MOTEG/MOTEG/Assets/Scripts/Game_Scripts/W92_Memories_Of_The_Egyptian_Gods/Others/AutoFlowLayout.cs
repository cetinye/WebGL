...
using W92_Memories_Of_The_Egyptian_Gods;
...
namespace UnityEngine.UI.Extensions
{
    ...
    public class AutoFlowLayout : LayoutGroup
    {
        ...
        private void CalculateCellSize()
        {
            ...
            //manually change child count to fit cards
            if (LevelManager.instance.cardAmount <= 6)
                childCount = 6;

            else if (LevelManager.instance.cardAmount <= 12)
                childCount = 12;

            else if (LevelManager.instance.cardAmount <= 16)
                childCount = 18;

            else if (LevelManager.instance.cardAmount <= 20)
                childCount = 22;
